...
tests_require = (
    'pytest==4.1.1',  # tests framework used
    'pytest-cov==2.6.1',  # coverage reports to verify tests quality
    'mock==2.0.0',  # tests mocking tool
    'python-daemon==2.2.2',  # used in test for easy creation of daemons
)
extras_require = {
    'docs': ['sphinx'],
    'tests': tests_require,
